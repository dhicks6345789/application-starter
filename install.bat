...
rem go build -ldflags "-X main.debugOn=true" application-starter\firstRun.go
...
erase "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\firstRun.exe"
...
copy /y application-starter\setUserRun.reg "C:\Program Files\Application Starter"
